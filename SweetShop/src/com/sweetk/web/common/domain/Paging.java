package com.sweetk.web.common.domain;
...
import com.sweetk.web.common.utils.CommProperty;
...
public class Paging extends ArrayList<Object> {
	...
	public int getBlockFirstPage() {
		if(this.blockFirstPage<0){
			this.blockFirstPage =0;
		}
	...
	public int getSPage(){
		return ((currentPage-1) * pagePerPage +1);
	}

	public int getEPage(){
		int num = (currentPage * pagePerPage);
		if(num > getTotalRow()){
			return getTotalRow();
		}else{
			return num;
