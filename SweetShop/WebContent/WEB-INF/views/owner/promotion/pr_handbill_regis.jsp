...
<script>
	...
	function saveCall() {
		...
		var url = "/shop_promotion_save.json";
						...
						<div class="gab_box">
							...
							<div class="photo">
								<ul>
									...
									<li class="photobox">
										<div class="photo_in">
											<img class="preview_image" src="/src/owner/images/contents/noimg.jpg" alt="이미지 등록"  style="width:100%; max-width:250px; height:auto;" />
							...
							<div class="btn_regis_area">
								<p><a href="javascript:saveCall()">등록</a></p>
