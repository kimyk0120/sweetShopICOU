				...
				<li class="left">
					...
					<div class="cont_area ">
						<div class="ev_regis_subject">
							<p>2016.06.08
								<span>이벤트 예정 D-1
									<strong class="mobile_icon"><a href="#"><img src="/src/owner/images/contents/icon_medal.png" /></a></strong><strong class="mobile_icon"><a href="#"><img src="/src/owner/images/contents/icon_report.png" /></a></strong>
								</span>
							</p>
							<input type="text" id="event_subject" class="regis_input_blur" value=" 이벤트 명을 입력하여 주세요.">
						</div>
					</div>
					...
					<div class="cont_area ev_regis_cont mt20">
						<ul class="tap_menu">
							...
							<li class="on gray"><a href="#">혜택 제공 이벤트</a><li>
						</ul>
						...
						<div class="gab_box">
							<div>
								...
								<input type="text" id="pum" class="regis_input_blur"  value="혜택이 적용될 서비스 품목을 입력해 주세요." style="font-size:14px;">
							</div>

							<div class="w_half whleft">
								<label for="detail_guide">제공 혜택</label>
								<input type="text" id="detail_guide" class="regis_input_blur bg_arrow"  onclick="suggest(1);" style="background: url('.././src/owner/images/contents/arrow_btm.png') no-repeat 98% center;" value="서비스 품목 제공        "><!-- 반응형웹 사이즈 문제로 화살표가 들어가는 인풋화면에서는 플레이스홀더 옆에 8칸 비워주세요 !! //-->
							...
							<div class="design_textarea">
								<div class="title">상세 설명</div>
											<textarea id="" placeholder="." class="write_input_blur">이용방법 등 이벤트에 대한 추가적인 설명을 입력해 주세요</textarea>
										 <script type="text/javascript">
